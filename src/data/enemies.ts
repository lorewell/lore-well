...
export const ENEMIES: Record<string, Enemy> = {
  slime: {
    ...
    goldReward: 5,
    dropTable: [
      { item: ITEMS.slime_jelly, chance: 0.92, minQty: 1, maxQty: 3 },
      { item: ITEMS.health_potion, chance: 0.22 },
    ],
    sprite: 'enemy_slime',
  },
  goblin: {
    ...
    goldReward: 15,
    dropTable: [
      { item: ITEMS.goblin_tooth, chance: 0.82, minQty: 1, maxQty: 2 },
      { item: ITEMS.health_potion, chance: 0.38 },
      { item: ITEMS.iron_sword, chance: 0.1 },
      { item: ITEMS.goblin_emblem, chance: 0.28 },
    ],
    sprite: 'enemy_goblin',
  },
  forest_wolf: {
    ...
    goldReward: 20,
    dropTable: [
      { item: ITEMS.wolf_fang, chance: 0.78, minQty: 1, maxQty: 2 },
      { item: ITEMS.leather_armor, chance: 0.15 },
      { item: ITEMS.health_potion, chance: 0.35 },
    ],
    sprite: 'enemy_wolf',
  },
  cave_spider: {
    ...
    goldReward: 10,
    dropTable: [
      { item: ITEMS.spider_silk, chance: 0.87, minQty: 1, maxQty: 3 },
      { item: ITEMS.mana_potion, chance: 0.32 },
      { item: ITEMS.iron_ore, chance: 0.42, minQty: 1, maxQty: 2 },
    ],
    sprite: 'enemy_spider',
  },
  goblin_mage: {
    ...
    goldReward: 18,
    dropTable: [
      { item: ITEMS.cursed_ash, chance: 0.82, minQty: 1, maxQty: 2 },
      { item: ITEMS.mana_potion, chance: 0.48 },
  ...
  stone_golem: {
    ...
    goldReward: 50,
    dropTable: [
      { item: ITEMS.stone_core, chance: 0.65, minQty: 1, maxQty: 2 },
      { item: ITEMS.chain_mail, chance: 0.12 },
      { item: ITEMS.elixir, chance: 0.38 },
      { item: ITEMS.iron_ore, chance: 0.72, minQty: 2, maxQty: 4 },
    ],
    sprite: 'enemy_golem',
  },
}
